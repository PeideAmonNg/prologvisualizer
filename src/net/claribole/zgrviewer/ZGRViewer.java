...
//	    formPanel.setBorder(BorderFactory.createEmptyBorder(SCREEN_MARGIN, SCREEN_MARGIN, 0, SCREEN_MARGIN));
    ...
    JMenuBar initViewMenu(){
    	JMenuItem enterProlog = new JMenuItem("Enter Prolog clause");
        ...
        ActionListener a0=new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                else if (e.getSource()==enterProlog){gvLdr.getPrologClause(enterProlog, DOTManager.DOT_PROGRAM, false);}
            }
        };
        
        enterProlog.addActionListener(a0);
